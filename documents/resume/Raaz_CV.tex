...
Massachusetts Institute of Technology, Department of EECS, Cambridge, USA \\[-2mm]
% \\
% \vspace*{-.1in}
...
Institute of Mathematical Statistics (IMS) New Researcher Travel Award
\quelle{London, 2022}
\vspone
...
\quelle{Berkeley, 2020}
\vspone

Berkeley Student Travel Grant, Jerusalem Joint Statistical
Event \quelle{Israel, 2018}
\vspone

Student Travel Award, NeurIPS 2018 \quelle{Canada, 2018}
\vspone

Oberwolfach Leibniz Graduate Students Travel Award
\quelle{Germany, 2017}
\vspone
...
Institute Silver Medal, IIT Bombay, for the highest Honors GPA (EE department)
\quelle{India, 2014}
\vspone

Best B. Tech. Project (undergraduate thesis) Award, IIT Bombay
\quelle{India, 2014}
\vspone

Manjula Bagmal Parikh Foundation Trust Prize, IIT Bombay
\quelle{India, 2014}
\vspone

Dilip R. Limaye Academic Excellence Award, IIT Bombay
 % for the most outstanding student (EE department)
\quelle{India, 2014}
\vspone

Prof. K. C. Mukherji Award, IIT Bombay
\quelle{India, 2014}
\vspone

Urvish Medh Memorial Prize for excellent academic performance in the EE department in first through senior year, IIT Bombay 
\quelle{India, 2011---2014}
\vspone

Institute Academic Excellence Prize for excellent institute wide academic performance in first through senior year, IIT Bombay
\quelle{India, 2011---2014}
\vspone

Aditya Choubey Prize for the best academic performance in the institute across the first year students, IIT Bombay
\quelle{India, 2011}
\vspone
...
\item Counterfactual inference in sequential experimental design. \emph{MIT Statistics and Data Science Conference (SDSCon) 2022, MIT}. \quelle{April 2022}
\item Counterfactual inference in sequential experimental design. \emph{Econometrics Lunch,  MIT}. \quelle{Mar 2022}
\item Near-optimal compression in near-linear time. \emph{ Hot topics workshop on Foundations of Stable, Generalizable and Transferable Statistical Learning, Mathematical Sciences Research Institute (MSRI), Berkeley}. (Invited talk) \quelle{Mar 2022}
    \item Counterfactual inference in sequential experimental design. \emph{Tea Talk, Laboratory for Information \& Decision Systems (LIDS),  MIT}. \quelle{Mar 2022}
    \item Counterfactual inference in sequential experimental design. \emph{Stat 300, Harvard University}. \quelle{Feb 2022}
    ...
    \item Kernel Thinning. \emph{Subset Selection in Machine Learning Workshop, International Conference on Machine Learning (Subset ML, ICML)}. (Contributed talk) \quelle{Jul 2021}

    \item Revisiting Complexity and the Bias-Variance Tradeoff: Using Minimum Description Length. \emph{North American School of Information Theory (NASIT)}. (Contributed poster)  \quelle{Jun 2021}
...
\begin{itemize}
  \item \emph{Sequential Decision Making}: STAT 234, Spring 2022, Taught by Prof. Susan Murphy. 
\end{itemize}
\textbf{Graduate Student Instructor, UC Berkeley} \quelle{2018---2019}
\begin{itemize}
\item \emph{Introduction
to Machine Learning}: EECS 189, Spring 2018, Taught by Prof. Anant Sahai and Prof. Jennifer Listgarten.
...
% \end{itemize}
\item \emph{Modern Statistical Prediction and Machine Learning}: STAT 154, Spring 2019, Taught by Prof. Bin Yu.
...
\vspace{-3mm}
Responsible for weekly discussions (40 students) besides exam grading, and (optional) help sessions for larger groups (up to 200 students)
\vspace{2mm}
\begin{itemize}
\item  \emph{Calculus}: MA 105, Fall 2011, Fall 2012 (Intensive Program for Entrants)
\item \emph{Linear Algebra}: MA 106, Spring 2012, Spring 2013, Spring 2014 (for IIT Bombay, and separately for Ministry of Human Resource Development, Government of India's online course for 400 undergraduate colleges)
\item \emph{Ordinary Differential Equations}: MA 108, Spring 2012, Spring 2013
\item \emph{Electromagnetism}: PH 103, Fall 2011
\item \emph{Partial Differential Equations}: MA 207, Summer 2012
% \begin{itemize}\itemsep0em
% 9-time TA for undergraduate courses on \emph{Calculus, Linear Algebra, Differential Equations, and Electromagnetism}. 
 % periodic extra sessions with attendance up to 200+ 
% \vspace{-1mm}
% \item TA for an online course on \emph{Linear Algebra}
...
\begin{itemize}
  \item \emph{STAT 234, Harvard University}: ``Offline off-policy reinforcement learning''
  \quelle{Feb 2022}
  \item \emph{EECS 189, UC Berkeley}: ``An Introduction to Ensemble
  Methods''  \quelle{Oct 2019}
  \item \emph{STAT 154, UC Berkeley}: ``Boosting'' \quelle{Apr 2019}
\end{itemize}
...
\textbf{Workshop}
\begin{itemize}
  \item Mentoring in the 2020-21 Summer Institute on ``Building Just-in-Time Adaptive Interventions Using Micro-Randomized Trial Designs'' for behavioral scientists (online)
  \quelle{Oct 2021}
\end{itemize}
\vsep
\textbf{Mentoring Activities}
\begin{itemize}\itemsep0em
  \item Institute for Data, Systems and Society (IDSS) Postdoc Mentoring Program for \emph{PhD students}, MIT \quelle{2022---}
...
\begin{itemize}\itemsep0em
  ...
  % \item Bernoulli (2 Papers)\hfill{\emph{2021--}}
  % \item Mathematics of Operations Research (1 paper) \hfill{\emph{2021--}}
  % \item Statistics and Computing (1 paper) \hfill{\emph{2021--}}
...
\begin{itemize}
  \item EECS Graduate Admissions Committee, UC Berkeley \quelle{2018---2020}
  \item EECS Graduate Admissions Committee, MIT \quelle{2021}
\end{itemize}
