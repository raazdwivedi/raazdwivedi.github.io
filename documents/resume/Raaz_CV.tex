...
{\bf FODSI Postdoctoral Fellow}\hspace{10.25cm} \emph{2021---}\\[1mm]
...
Student Travel Award, SAMSI QMC Workshop 2018 \quelle{Raleigh-Durham,
2017}
% \vspone
...
President of India Gold Medal, IIT Bombay, for highest GPA in the institute
\hfill \emph{India, 2014}
% \vspone

Institute Silver Medal,  IIT Bombay, for highest
Honors GPA in the EE department
\hfill \emph{India, 2014}
% \vspone
...
and statistical accuracy}}, \textit{arXiv preprint}.
\item \textbf{Raaz Dwivedi} and Lester Mackey, \href{https://arxiv.org/abs/2110.01593}{\ptitle{{Generalized kernel thinning}}}, \textit{arXiv preprint}.
\item Abhishek Shetty, \textbf{Raaz Dwivedi} and Lester Mackey, \href{https://arxiv.org/abs/2111.07941}{\ptitle{{Distribution compression in near-linear time}}}, \textit{arXiv preprint}.
\end{enumerate}
...
\textbf{Teaching Assistant, IIT Bombay and MHRD, India} \quelle{2011---2014}
\begin{itemize}
